...
class DealpathClient:
    ...
    def get_deals(self, **filters):
        response = requests.get(
            f"{BASE_URL}/deals", headers=self.headers, params=filters
        )
    ...
    def get_assets(self, **filters):
        response = requests.get(
            f"{BASE_URL}/assets", headers=self.headers, params=filters
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_field_definitions(self, **params):
        response = requests.get(
            f"{BASE_URL}/field_definitions", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_fields_by_deal_id(self, deal_id: str, **params):
        response = requests.get(
            f"{BASE_URL}/fields/deal/{deal_id}", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_fields_by_asset_id(self, asset_id: str, **params):
        response = requests.get(
            f"{BASE_URL}/fields/asset/{asset_id}", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_fields_by_loan_id(self, loan_id: str, **params):
        response = requests.get(
            f"{BASE_URL}/fields/loan/{loan_id}", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_file_by_id(self, file_id: str):
        ...
        url_response = requests.get(
            f"{BASE_URL}/file/{file_id}/download_url", headers=self.headers
        )
    ...
    def get_file_tag_definitions(self, **params):
        response = requests.get(
            f"{BASE_URL}/file_tag_definitions", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_investments(self, **params):
        response = requests.get(
            f"{BASE_URL}/investments", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_loans(self, **params):
        response = requests.get(
            f"{BASE_URL}/loans", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_people(self, **params):
        response = requests.get(
            f"{BASE_URL}/people", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_property_by_id(self, property_id: str):
        response = requests.get(
            f"{BASE_URL}/property/{property_id}", headers=self.headers
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_properties(self, **params):
        response = requests.get(
            f"{BASE_URL}/properties", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_roles_by_deal_id(self, deal_id: str, **params):
        response = requests.get(
            f"{BASE_URL}/roles/deal/{deal_id}", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def get_roles_by_asset_id(self, asset_id: str, **params):
        response = requests.get(
            f"{BASE_URL}/roles/asset/{asset_id}", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
    ...
    def search(self, **params):
        response = requests.get(
            f"{BASE_URL}/search", headers=self.headers, params=params
        )
        response.raise_for_status()
        return response.json()
